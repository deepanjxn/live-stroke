      ...
      <Container>
        <div className="p-6">
          ...
          <div className="mt-3 grid grid-cols-[1fr_292px] gap-3">
            <div className="col-span-2 flex h-[292px] items-center justify-center rounded-2xl border border-gray-100 bg-gray-50">
              <LiveStroke radius={9999}>
            ...
            <div className="flex h-[292px] items-center justify-center rounded-2xl border border-gray-100 bg-gray-50">
              <LiveStroke radius={9999}>
